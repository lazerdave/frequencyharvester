...
KiwiSDR Recorder - Automated radio recording and podcast generation system for capturing 198 kHz Shipping Forecast broadcasts from the KiwiSDR network.
...
- Python: 3.11.2
- Base directory: /home/pi/projects/recorder
...
- **kiwi_recorder.py** (1,022 lines) - Main consolidated script
- **requirements.txt** - Python dependencies (requests>=2.28.0)
- **Old scripts** - Backed up to /home/pi/old_scripts/
...
4. **Cron Setup** (cmd_setup)
   ...
   - Schedules: scan at 00:42, record at 00:47 & 05:19 London time
